...
<div class="admin-content-body">
	<div class="am-cf am-padding am-padding-bottom-0">
		...
		<button id="addShop" class="am-btn am-btn-primary am-btn-sm am-fr">新增商户</button>
	</div>
	<hr>
	<!-- 列表-nav start-->
	<div class="am-g">
			...
			<div class="am-u-sm-12 am-u-md-2 max_w_200">
				<div class="am-form-group am-form-icon">
					<i class="am-icon-calendar"></i> <input id="startTime"
															type="text" class="am-form-field am-input-sm"
															placeholder="开始日期"
		...
		<div class="am-form-group am-u-sm-12 am-u-md-1 am-fr am-w-auto">
			<button id="search" class="am-btn am-btn-primary am-btn-sm am-fr">搜索</button>
		</div>
	</div>
	<!-- 列表-nav end-->
	<br/>
...
<script id="tpl-shop-detail" type="text/html">
	<div class="am-tabs am-margin">
		<ul class="am-tabs-nav am-nav am-nav-tabs">
			<li class="am-active"><a href="#xAdmin-tab">商户信息</a></li>
		</ul>
				...
				<form class="am-form" id="z_form">
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-u-md-4 am-u-end">
							<input type="text" value="{{username}}" placeholder="登录账号为5~20位字母数字组合，字母开头" {{readonly}}
								   {{action== "update" ? "readonly" : ""}} name="username">
						</div>
					</div>
					{{if action == "save"}}
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-u-md-4 am-u-end">
							<input type="text" value="{{password}}" placeholder="输入6~16位数字字母密码" {{readonly}}
								   name="password">
						</div>
					</div>
					{{/if}}
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-u-md-4 am-u-end">
							<input type="text" value="{{registertime}}" placeholder="选择注册时间" readonly
								   name="registerTime">
						</div>
					</div>
					<div class="am-g am-margin-top">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-5 am-u-md-5 am-u-end">
							<div class="am-cf am-u-md-12" style="padding: 0;">
								{{if licenceimgurl}}
								<div class="am-u-sm-5 am-u-sm-uncentered pos-rel pointer"
									 style="width: 47.5%;padding: 0;">
									<img class="am-thumbnail banner addImg" src="{{licenceimgurl}}" alt=""
										 id="licenceImgURL"/>
								</div>
								{{else}}
								<div class="am-u-sm-5 am-u-sm-uncentered pos-rel pointer"
...
<script type="text/html" id="HomepageShopListTpl1">
	<button class="am-btn am-btn-default am-btn-xs" style="margin: 0 3px 3px 0;" action="url" value="{{ id }}">
		<span class="am-icon-link"></span>
		<span>获取URL</span>
	</button>
	<button class="am-btn am-btn-default am-btn-xs" style="margin: 0 3px 3px 0;" action="edit">
	...
	{{ /if }}
	<button class="am-btn am-btn-default am-btn-xs" style="margin: 0 3px 3px 0;" action="resetPwd">
		...
		ShopTable.prototype = {
					...
					columnDefs: [
						{
							...
							"render": function (data, type, row) {
								// url edit active resetPwd
								//var arr = ["view", "edit"];
								//arr.push(row.status == "0" ? "active" : "forbid");
								//arr.push("resetPwd");
								//return template("btn-tpl", {"btnArr": llg_returnBtn(arr)});
								var render = template.compile($('#HomepageShopListTpl1').html());
								var html = render({status: row.status, id: row.id});
								return html;
							}
						}
					]
			...
			clickBtnFun: function () {
				...
				$('#x-table tbody').on('click', 'button', function () {
					...
					if (action === "edit") {
						$.ajax({
							...
							success: function (res) {
								...
								self.initDate($('input[name="registerTime"]'));
								//scrollToForm();
								$('.admin-content').scrollTo('#detailForm', 500);
								self.createUploader();
								self.uploadImg();
								self.updateShop(id);
							},
					...
					if (action === 'url') {
						$.post('/index.php/Admin/Shop/buildWechatURL', {shopId: theButton.attr('value')}, function (res) {
							modal_alert(res.data);
						});
					}
				});
			},
