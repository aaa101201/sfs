 ...
 */
  ...
  class Wechat {
    ...
    protected function responseImage($mediaId, $funcFlag = 0){
        ...
        $time = time();
        $resultStr = sprintf($textTpl, $this->getRequest('fromusername'), $this->getRequest('tousername'), $time, $mediaId);
        echo $resultStr;
        exit;
    }
    ...
    public function run() {
      ...
      $this->trackLog('msgtype', $this->getRequest('msgtype'));
      $this->trackLog('event', $this->getRequest('event'));
